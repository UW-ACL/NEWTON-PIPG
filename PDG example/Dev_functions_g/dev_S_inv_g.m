...
while temp <= length(z0)
    ...
    if Const_type == 1
       [Q(temp: proj_index(1, temp), temp: proj_index(1, temp)),Q_inv(temp: proj_index(1, temp), temp: proj_index(1, temp))]  = dev_jacob_box(z0(temp: proj_index(1, temp)),proj_coefficients(2,temp: proj_index(1, temp))' ...
            , proj_coefficients(1, temp: proj_index(1, temp))', P(temp: proj_index(1, temp)), alpha);
    elseif Const_type == 2
        [Q(temp: proj_index(1, temp), temp: proj_index(1, temp)),Q_inv(temp: proj_index(1, temp), temp: proj_index(1, temp))] = dev_jacob_ball(z0(temp: proj_index(1, temp)), proj_coefficients(1,temp), P(temp: proj_index(1, temp)), alpha);
    elseif Const_type == 3
        [Q(temp: proj_index(1, temp), temp: proj_index(1, temp)),Q_inv(temp: proj_index(1, temp), temp: proj_index(1, temp))] = dev_jacob_soc(z0(temp: proj_index(1, temp)), proj_coefficients(1,temp), P(temp: proj_index(1, temp)), alpha);
    end
    %update
