                         ...
                         const coder::array<real_T, 1U> &in3)
{
  ...
  int32_T stride_1_1;
  loop_ub = in2.size(0);
  in1.set_size(&oe_emlrtRTEI, &sp, loop_ub, in1.size(1));
  if (in3.size(0) == 1) {
    b_loop_ub = in2.size(1);
  } else {
    b_loop_ub = in3.size(0);
  }
  in1.set_size(&oe_emlrtRTEI, &sp, in1.size(0), b_loop_ub);
                         ...
                         const coder::array<creal_T, 1U> &in5)
{
  ...
  in3.set_size(&me_emlrtRTEI, &sp, loop_ub);
                         ...
                         const coder::array<creal_T, 1U> &in4)
{
  ...
  in1.set_size(&le_emlrtRTEI, &sp, loop_ub);
  stride_0_0 = (in3.size(0) != 1);
  stride_1_0 = (in4.size(0) != 1);
  for (int32_T i{0}; i < loop_ub; i++) {
    int32_T i1;
           ...
           const coder::array<real_T, 1U> &in3)
{
  ...
  in1.set_size(&ke_emlrtRTEI, &sp, loop_ub);
  stride_0_0 = (in2.size(0) != 1);
  stride_1_0 = (in3.size(0) != 1);
  for (int32_T i{0}; i < loop_ub; i++) {
    real_T d;
