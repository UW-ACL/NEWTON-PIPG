...
//
// _coder_dev_xpipg_g_for_N_30_api.cpp
//
// Code generation for function '_coder_dev_xpipg_g_for_N_30_api'
//
...
static const mxArray *emlrt_marshallOut(const struct0_T &u)
{
  static const char_T *sv[8]{"converge", "iter4", "iter8",      "iter12",
...
void dev_xpipg_g_for_N_30_api(const mxArray *const prhs[18],
                              const mxArray **plhs)
{
  emlrtStack st{
      nullptr, // site
  ...
  dev_xpipg_g_for_N_30(&st, P, A, q, g, N, nx, nu, nineq, proj_index_all,
                       proj_coefficient_all, cone_k_polar, z_1, lam, rho, omg,
                       maxit, tol, display, &out);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(out);
}

// End of code generation (_coder_dev_xpipg_g_for_N_30_api.cpp)
