  ...
  for (int32_T b_i{0}; b_i < i; b_i++) {
    ...
    for (int32_T j{0}; j <= b_i; j++) {
      for (int32_T k{0}; k < loop_ub; k++) {
        int32_T C_data_tmp;
        if (j + 1 > C_size[1]) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, C_size[1], &xe_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (b_i + 1 > C_size[0]) {
          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, C_size[0], &ye_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (k + 1 > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, loop_ub, &af_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (b_i + 1 > i) {
          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, i, &bf_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (j + 1 > B_size[1]) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, B_size[1], &cf_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (k + 1 > B_size[0]) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, B_size[0], &df_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (j + 1 > C_size[1]) {
          emlrtDynamicBoundsCheckR2012b(j + 1, 1, C_size[1], &ef_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
        if (b_i + 1 > C_size[0]) {
          emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, C_size[0], &ff_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      ...
      if (j + 1 > C_size[1]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, C_size[1], &gf_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (b_i + 1 > C_size[0]) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, C_size[0], &hf_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (b_i + 1 > C_size[1]) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, C_size[1], &if_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      if (j + 1 > C_size[0]) {
        emlrtDynamicBoundsCheckR2012b(j + 1, 1, C_size[0], &jf_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
