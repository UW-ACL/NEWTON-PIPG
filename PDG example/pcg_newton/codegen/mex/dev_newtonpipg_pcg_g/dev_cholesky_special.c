                          ...
                          real_T L[5800])
{
  ...
  /*  below the diag.  */
  memset(&L[0], 0, 5800U * sizeof(real_T));
  /*  Compute L_11 */
  st.site = &bh_emlrtRSI;
  for (i = 0; i < 10; i++) {
    for (i1 = 0; i1 < 10; i1++) {
  ...
  iv[1] = 10;
  temp[1] = n;
  emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &temp[0], 2, &ic_emlrtECI,
                                (emlrtCTX)sp);
  for (i = 0; i < 10; i++) {
    for (i1 = 0; i1 < 10; i1++) {
  ...
  while ((!exitg1) && (b_i - 1 < 28)) {
    ...
    if (y) {
      ...
      memset(&A[0], 0, 100U * sizeof(real_T));
      for (info = 0; info < 10; info++) {
      ...
      if (info != 0) {
        ...
        iv[1] = 10;
        temp[1] = n;
        emlrtSubAssignSizeCheckR2012b(&iv[0], 2, &temp[0], 2, &jc_emlrtECI,
                                      (emlrtCTX)sp);
        for (i = 0; i < 10; i++) {
          for (i1 = 0; i1 < 10; i1++) {
...
/* End of code generation (dev_cholesky_special.c) */
