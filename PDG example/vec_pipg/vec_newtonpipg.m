function out = vec_newtonpipg(P,H,Ht,q, g,N, nx, nu,nineq, proj_index_all, proj_coefficient_all,cone_k_polar, z1,lam, rho, omg, maxit,...
...
for k = 1:maxit
    ...
    if k >= newtonactive +temp + newtonwaitlinear*newtonwait_factor + newtonwaitexp^newtonwait_factor-1
        ...
        [dzw, flag]  = vec_newtonpipgupdate(alpha, beta, rho,R,P, J_D, H, Ht, J_k_polar);%R = old - new
