function  out = dev_xpipg_g_for_N_30_withtimer(P, A, q, g, N, nx, nu,nineq, proj_index_all, proj_coefficient_all,cone_k_polar, z_1,lam, rho, omg, maxit,tol, display)%#codegen
...
out.solve_time = 0;
out.nR = 0.0;
out.timeout = zeros(1,20000);
out.pipgR = zeros(1,20000);
nR = 0.0;
w1 = zeros(nH_r,1);
%%%%%%%%%%%%%%%%%%%
%PIPG
...
for k = 1: maxit
    ...
    out.timeout(timeind) = totaltime;
    out.pipgR(timeind) = norm(R);
    timeind = timeind + 1;
    % 
