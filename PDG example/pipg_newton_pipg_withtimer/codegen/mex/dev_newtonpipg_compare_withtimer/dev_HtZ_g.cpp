                  ...
                  real_T out_data[])
{
  ...
  // same.
  if (!(ne + 319.0 >= 0.0)) {
    emlrtNonNegativeCheckR2012b(ne + 319.0, &k_emlrtDCI, (emlrtConstCTX)&sp);
  }
  s = static_cast<int32_T>(muDoubleScalarFloor(ne + 319.0));
  if (ne + 319.0 != s) {
    emlrtIntegerCheckR2012b(ne + 319.0, &j_emlrtDCI, (emlrtConstCTX)&sp);
  }
  ...
  for (int32_T b_i{0}; b_i < 30; b_i++) {
    ...
    if (b_i + 1 == 1) {
      ...
      for (i = 0; i < 10; i++) {
        i2 = temp_index[i];
        if (i2 > w_size) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, w_size, &i_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      }
      ...
      if (b_i + 1 <= 29) {
        ...
        for (i = 0; i < 10; i++) {
          i2 = temp_index[i];
          if (i2 > w_size) {
            emlrtDynamicBoundsCheckR2012b(i2, 1, w_size, &j_emlrtBCI,
                                          (emlrtConstCTX)&sp);
          }
        }
        for (out_size_tmp = 0; out_size_tmp < 11; out_size_tmp++) {
      ...
      for (i2 = 0; i2 < out_size_tmp; i2++) {
        ...
        if ((k < 1) || (k > w_size)) {
          emlrtDynamicBoundsCheckR2012b(k, 1, w_size, &n_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      }
      if (ne < 1.0) {
      ...
      if (y_size_idx_1 != out_size_tmp) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, out_size_tmp, &h_emlrtECI,
                                        (emlrtConstCTX)&sp);
      }
