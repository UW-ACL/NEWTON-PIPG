          ...
          if (d1 == 1.0) {
            ...
            if ((static_cast<int32_T>(temp) < 1) ||
              ...
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(temp), 1,
                                            loop_ub_tmp, &xd_emlrtBCI, &st);
            }
            if (loop_ub_tmp < 11) {
              emlrtDynamicBoundsCheckR2012b(11, 1, loop_ub_tmp, &yd_emlrtBCI,
                                            &st);
            }
            if ((static_cast<int32_T>(temp) < 1) ||
                (static_cast<int32_T>(temp) > loop_ub)) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(temp), 1,
                                            loop_ub, &ae_emlrtBCI, &st);
            }
            if (loop_ub < 11) {
              emlrtDynamicBoundsCheckR2012b(11, 1, loop_ub, &be_emlrtBCI, &st);
            }
            ...
            if ((static_cast<int32_T>(temp) < 1) ||
                (static_cast<int32_T>(temp) > loop_ub_tmp)) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(temp), 1,
                                            loop_ub_tmp, &ce_emlrtBCI, &st);
            }
            if (loop_ub_tmp < 11) {
              emlrtDynamicBoundsCheckR2012b(11, 1, loop_ub_tmp, &de_emlrtBCI,
                                            &st);
            }
            if ((static_cast<int32_T>(temp) < 1) ||
                (static_cast<int32_T>(temp) > loop_ub)) {
              emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(temp), 1,
                                            loop_ub, &ee_emlrtBCI, &st);
            }
            if (loop_ub < 11) {
              emlrtDynamicBoundsCheckR2012b(11, 1, loop_ub, &fe_emlrtBCI, &st);
            }
