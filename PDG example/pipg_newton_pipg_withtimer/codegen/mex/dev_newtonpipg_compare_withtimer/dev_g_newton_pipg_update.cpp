    ...
    real_T alpha, real_T beta, real_T rho, real_T delta_Y, real_T dzw[616])
{
  ...
  dev_S_inv_g(st, temp_prime, nx, nu, proj_index_all, proj_coefficient_all, P,
              alpha, SD->f0.Q_data, Q_size, Q_inv_data, Q_inv_size);
    ...
    if (b_i + 1 < 30) {
      ...
      for (i = 0; i < ii_size; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
          b_Q_inv_data[i1 + loop_ub * i] =
              Q_inv_data[(b_i + 30 * i1) + 30 * Q_inv_size[1] * i];
        }
      }
      for (i = 0; i < y_size_idx_1; i++) {
      ...
      tmp_size = Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv1,
      ...
      for (i = 0; i < ii_size; i++) {
        for (i1 = 0; i1 < loop_ub; i1++) {
          b_Q_inv_data[i1 + loop_ub * i] =
              Q_inv_data[(30 * i1 + 30 * Q_inv_size[1] * i) + 29];
        }
      }
      for (i = 0; i < y_size_idx_1; i++) {
      ...
      tmp_size = Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv,
                          proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
  ...
  for (int32_T b_i{0}; b_i < 30; b_i++) {
    ...
    if (b_i + 1 < 30) {
      ...
      iv3[1] = Q_inv_size[1];
      b_st.site = &uf_emlrtRSI;
      tmp_size = b_Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv3,
                            proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &y_emlrtECI,
                                        &st);
      ...
      iv2[1] = Q_inv_size[1];
      b_st.site = &vf_emlrtRSI;
      tmp_size = b_Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv2,
                            proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &ab_emlrtECI,
                                        &st);
    ...
    if (b_i + 1 == 1) {
      ...
      for (i = 0; i < 11; i++) {
        if (i + 1 > static_cast<int32_T>(ne + 319.0)) {
          emlrtDynamicBoundsCheckR2012b(
              i + 1, 1, static_cast<int32_T>(ne + 319.0), &k_emlrtBCI, &st);
        }
        out[i] = R_z_data[i];
      }
    } else {
      ...
      if (b_i + 1 <= 29) {
        for (i = 0; i < 10; i++) {
          i1 = temp_index[i];
          if (i1 > 290) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, 290, &tb_emlrtBCI, &st);
          }
        }
        for (ii_size = 0; ii_size < 11; ii_size++) {
          s = 0.0;
      ...
      for (i1 = 0; i1 < y_size_idx_1; i1++) {
        ...
        if ((tmp_size < 1) || (tmp_size > static_cast<int32_T>(ne + 319.0))) {
          emlrtDynamicBoundsCheckR2012b(
              tmp_size, 1, static_cast<int32_T>(ne + 319.0), &m_emlrtBCI, &st);
        }
      ...
      for (tmp_size = 0; tmp_size < y_size_idx_1; tmp_size++) {
        ...
        if ((ii_size < 1) || (ii_size > 290)) {
          emlrtDynamicBoundsCheckR2012b(ii_size, 1, 290, &ub_emlrtBCI, &st);
        }
      ...
      for (i1 = 0; i1 < loop_ub; i1++) {
        ...
        if ((tmp_size < 1) || (tmp_size > static_cast<int32_T>(ne + 319.0))) {
          emlrtDynamicBoundsCheckR2012b(
              tmp_size, 1, static_cast<int32_T>(ne + 319.0), &o_emlrtBCI, &st);
        }
  ...
  for (int32_T b_i{0}; b_i < 30; b_i++) {
    ...
    if (b_i + 1 < 30) {
      ...
      iv5[1] = Q_size[1];
      b_st.site = &uf_emlrtRSI;
      tmp_size = Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv5,
                          proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &y_emlrtECI,
                                        &st);
      ...
      iv4[1] = Q_size[1];
      b_st.site = &vf_emlrtRSI;
      tmp_size = Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv4,
                          proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &ab_emlrtECI,
                                        &st);
  ...
  for (int32_T b_i{0}; b_i < 30; b_i++) {
    ...
    if (b_i + 1 < 30) {
      ...
      iv7[1] = Q_size[1];
      b_st.site = &uf_emlrtRSI;
      tmp_size = b_Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv7,
                            proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &y_emlrtECI,
                                        &st);
      ...
      iv6[1] = Q_size[1];
      b_st.site = &vf_emlrtRSI;
      tmp_size = b_Q_v_unit(b_st, R_z_data, y_size_idx_1, b_Q_inv_data, iv6,
                            proj_temp_index, d_tmp_data);
      if (y_size_idx_1 != tmp_size) {
        emlrtSubAssignSizeCheck1dR2017a(y_size_idx_1, tmp_size, &ab_emlrtECI,
                                        &st);
