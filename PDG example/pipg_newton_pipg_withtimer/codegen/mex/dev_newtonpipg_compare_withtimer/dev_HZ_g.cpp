  ...
  for (int32_T i{0}; i < 29; i++) {
    ...
    if (index_zstart > index_zstart + 10) {
      ...
      if (index_zstart > z_size) {
        emlrtDynamicBoundsCheckR2012b(index_zstart, 1, z_size, &c_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      b_i = index_zstart - 1;
      if (index_zstart + 10 > z_size) {
        emlrtDynamicBoundsCheckR2012b(index_zstart + 10, 1, z_size, &d_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i1 = index_zstart + 10;
    }
    ...
    if (static_cast<real_T>(index_zstart) + 11.0 > d1) {
      ...
      if (index_zstart + 11 > z_size) {
        emlrtDynamicBoundsCheckR2012b(index_zstart + 11, 1, z_size, &f_emlrtBCI,
                                      (emlrtConstCTX)&sp);
      }
      i2 = index_zstart + 10;
