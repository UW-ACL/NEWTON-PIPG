...
//
// _coder_dev_newtonpipg_compare_withtimer_api.cpp
//
// Code generation for function '_coder_dev_newtonpipg_compare_withtimer_api'
//
...
static const mxArray *emlrt_marshallOut(const struct1_T &u)
{
  static const char_T *sv[8]{"converge", "xi", "eta",     "solve_time",
                             "ntime",    "k",  "timeout", "pipgR"};
  const mxArray *b_y;
  const mxArray *c_y;
  const mxArray *d_y;
  const mxArray *e_y;
  ...
  emlrtSetFieldR2017b(y, 0, "timeout", emlrt_marshallOut(u.timeout), 6);
  emlrtSetFieldR2017b(y, 0, "pipgR", emlrt_marshallOut(u.pipgR), 7);
  return y;
}
...
static const mxArray *emlrt_marshallOut(const real_T u[2000])
{
  static const int32_T iv[2]{1, 2000};
  const mxArray *m;
  const mxArray *y;
  real_T *pData;
  y = nullptr;
...
void f_dev_newtonpipg_compare_withti(d_dev_newtonpipg_compare_withti *SD,
                                     ...
                                     const mxArray **plhs)
{
  ...
  dev_newtonpipg_compare_withtimer(
      SD, &st, P, A, q, g, N, nx, nu, nineq, proj_index_all,
      proj_coefficient_all, cone_k_polar, z_1, lam, rho, omg, &newton_coeff,
      maxit, tol, pertub, display, &SD->f1.out);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(SD->f1.out);
}

// End of code generation (_coder_dev_newtonpipg_compare_withtimer_api.cpp)
