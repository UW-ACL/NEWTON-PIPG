  ...
  for (int32_T t{0}; t < 29; t++) {
    ...
    if (29 - t == 29) {
      ...
      for (i = 0; i < loop_ub; i++) {
        ...
        if (b > 290) {
          emlrtDynamicBoundsCheckR2012b(b, 1, 290, &pg_emlrtBCI,
                                        (emlrtConstCTX)&sp);
        }
      ...
      for (int32_T b_i{0}; b_i < 10; b_i++) {
        if (10 - b_i > loop_ub) {
          emlrtDynamicBoundsCheckR2012b(10 - b_i, 1, loop_ub, &sg_emlrtBCI,
                                        &st);
        }
        y[9 - b_i] =
        ...
        for (a = 0; a < b_i; a++) {
          b = (a - b_i) + 10;
          if (b + 1 > 10) {
            emlrtDynamicBoundsCheckR2012b(b + 1, 1, 10, &og_emlrtBCI, &st);
          }
