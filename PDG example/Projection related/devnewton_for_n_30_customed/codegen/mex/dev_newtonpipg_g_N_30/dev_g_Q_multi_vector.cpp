      ...
      if (beta1 == 1.0) {
        ...
        if (loop_ub - 1 != b_loop_ub - 1) {
          if (((loop_ub == 1) && (c_loop_ub == 1)) || (b_loop_ub == 1)) {
            ...
            emlrtErrorWithMessageIdR2018a(
                &b_st, &o_emlrtRTEI, "MATLAB:innerdim", "MATLAB:innerdim", 0);
          }
        }
