...
static int32_T binary_expand_op_9(real_T in1_data[], const boolean_T in2_data[],
                                        ...
                                        int32_T &J_af_size)
{
  ...
  while ((!exitg1) && (temp <= z0_size)) {
    ...
    if (temp != static_cast<int32_T>(muDoubleScalarFloor(temp))) {
      emlrtIntegerCheckR2012b(temp, &w_emlrtDCI, (emlrtConstCTX)&sp);
    }
    ...
    if (d == rtInf) {
      ...
      if (d1 == 1.0) {
        ...
        i = i2 - i6;
        if (i != tmp_size) {
          emlrtSubAssignSizeCheck1dR2017a(i, tmp_size, &s_emlrtECI,
                                          (emlrtConstCTX)&sp);
        }
        ...
        if ((loop_ub != scalarLB) && ((loop_ub != 1) && (scalarLB != 1))) {
          emlrtDimSizeImpxCheckR2021b(loop_ub, scalarLB, &o_emlrtECI, &st);
        }
        b_loop_ub = i6 - i5;
        if ((loop_ub != b_loop_ub) && ((loop_ub != 1) && (b_loop_ub != 1))) {
          emlrtDimSizeImpxCheckR2021b(loop_ub, b_loop_ub, &n_emlrtECI, &st);
        }
        if (loop_ub == scalarLB) {
          tmp_size = loop_ub;
        ...
        if ((tmp_size != loop_ub) && ((tmp_size != 1) && (loop_ub != 1))) {
          emlrtDimSizeImpxCheckR2021b(tmp_size, loop_ub, &m_emlrtECI, &st);
        }
        if (tmp_size == loop_ub) {
        ...
        i = i3 - vectorUB;
        if (i != tmp_size) {
          emlrtSubAssignSizeCheck1dR2017a(i, tmp_size, &p_emlrtECI,
                                          (emlrtConstCTX)&sp);
        }
        loop_ub = static_cast<int8_T>(i);
        for (i = 0; i < loop_ub; i++) {
        ...
        i = i2 - i1;
        if (i != tmp_size) {
          emlrtSubAssignSizeCheck1dR2017a(i, tmp_size, &r_emlrtECI,
                                          (emlrtConstCTX)&sp);
        }
        loop_ub = static_cast<int8_T>(i);
        for (i = 0; i < loop_ub; i++) {
        ...
        if (loop_ub < 1) {
          ...
          if (loop_ub + 1 < 1) {
            emlrtDynamicBoundsCheckR2012b(1, 1, loop_ub + 1, &q_emlrtBCI, &st);
          }
          if (loop_ub > loop_ub + 1) {
            emlrtDynamicBoundsCheckR2012b(loop_ub, 1, loop_ub + 1, &p_emlrtBCI,
                                          &st);
          }
          b_loop_ub = loop_ub;
        }
        ...
        for (int32_T i4{0}; i4 < b_loop_ub; i4++) {
          x_data[i4] = z0_data[static_cast<int8_T>(i) + i4];
        }
        if (b_loop_ub == 0) {
          nm2 = 0.0;
        } else {
        ...
        i = i3 - i2;
        if (i != tmp_size) {
          emlrtSubAssignSizeCheck1dR2017a(i, tmp_size, &q_emlrtECI,
                                          (emlrtConstCTX)&sp);
        }
        loop_ub = static_cast<int8_T>(i);
        for (i = 0; i < loop_ub; i++) {
