...
%}
    ...
    switch alg_type{1}
        case 'VEC'
            ...
            switch alg_type{2}
                case 'old_infeas'
                    func_name = "solver/expipg/expipg_vec_v2" + name_suffix;
                    codegen("solver/expipg/expipg_vec_v2.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_vec_v2/","-o",func_name,"-args",vec_args);
                case 'new_infeas'
                    func_name = "solver/expipg/expipg_vec" + name_suffix;
                    codegen("solver/expipg/expipg_vec.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_vec/","-o",func_name,"-args",vec_args);
                case 'new'
                    func_name = "solver/expipg/expipg_vec_v3" + name_suffix;
                    codegen("solver/expipg/expipg_vec_v3.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_vec_v3/","-o",func_name,"-args",vec_args);    
                otherwise
                    error("Invalid detection critiera; should be 'old_infeas', 'new_infeas' or 'new'");
            end
        case 'DVEC'
            ...
            switch alg_type{2}
                case 'old_infeas'
                    func_name = "solver/expipg/expipg_dvec_v2" + name_suffix;
                    codegen("solver/expipg/expipg_dvec_v2.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_dvec_v2/","-o",func_name,"-args",dvec_args);
                case 'new_infeas'
                    func_name = "solver/expipg/expipg_dvec" + name_suffix;
                    codegen("solver/expipg/expipg_dvec.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_dvec/","-o",func_name,"-args",dvec_args);
                case 'new'
                    func_name = "solver/expipg/expipg_dvec_v3" + name_suffix;
                    codegen("solver/expipg/expipg_dvec_v3.m","-config",mxcfg,"-d","solver/expipg/codegen/mex/expipg_dvec_v3/","-o",func_name,"-args",dvec_args);    
                otherwise
                    error("Invalid detection critiera; should be 'old_infeas', 'new_infeas' or 'new'");
            end
        otherwise
