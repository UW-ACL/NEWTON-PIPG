...
//
// _coder_dev_pipg_api.cpp
//
// Code generation for function '_coder_dev_pipg_api'
//
...
static const mxArray *emlrt_marshallOut(const struct1_T *u)
{
  static const int32_T i{100};
  static const char_T *b_sv[10]{
      "alpha", "beta",  "converge", "residualfirstactive", "iterfirstactive",
      "iter4", "iter8", "iter12",   "computationtime",     "shiftactiveamount"};
  const mxArray *b_y;
  const mxArray *c_y;
  const mxArray *d_y;
  const mxArray *e_y;
  ...
  emlrtAssign(&b_y, m);
  emlrtSetFieldR2017b(y, 0, "alpha", b_y, 0);
  c_y = nullptr;
  ...
  emlrtAssign(&d_y, m);
  emlrtSetFieldR2017b(y, 0, "converge", d_y, 2);
  e_y = nullptr;
  m = emlrtCreateDoubleScalar(u->residualfirstactive);
  emlrtAssign(&e_y, m);
  emlrtSetFieldR2017b(y, 0, "residualfirstactive", e_y, 3);
  f_y = nullptr;
  m = emlrtCreateDoubleScalar(u->iterfirstactive);
  emlrtAssign(&f_y, m);
  emlrtSetFieldR2017b(y, 0, "iterfirstactive", f_y, 4);
  g_y = nullptr;
  m = emlrtCreateDoubleScalar(u->iter4);
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(y, 0, "iter4", g_y, 5);
  h_y = nullptr;
  m = emlrtCreateDoubleScalar(u->iter8);
  emlrtAssign(&h_y, m);
  emlrtSetFieldR2017b(y, 0, "iter8", h_y, 6);
  i_y = nullptr;
  m = emlrtCreateDoubleScalar(u->iter12);
  emlrtAssign(&i_y, m);
  emlrtSetFieldR2017b(y, 0, "iter12", i_y, 7);
  j_y = nullptr;
  m = emlrtCreateDoubleScalar(u->computationtime);
  emlrtAssign(&j_y, m);
  emlrtSetFieldR2017b(y, 0, "computationtime", j_y, 8);
  k_y = nullptr;
  m = emlrtCreateNumericArray(1, (const void *)&i, mxDOUBLE_CLASS, mxREAL);
  pData = emlrtMxGetPr(m);
  for (int32_T b_i{0}; b_i < 100; b_i++) {
    pData[b_i] = u->shiftactiveamount[b_i];
  }
  emlrtAssign(&k_y, m);
  emlrtSetFieldR2017b(y, 0, "shiftactiveamount", k_y, 9);
  return y;
}
...
void b_dev_pipg_api(dev_pipgStackData *SD, const mxArray *prhs,
                    const mxArray **plhs)
{
  emlrtStack st{
      nullptr, // site
  ...
  emlrt_marshallIn(&st, emlrtAliasP(prhs), "ppv", &SD->f0.ppv);
  // Invoke the target function
  dev_pipg(&st, &SD->f0.ppv, &out);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(&out);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

// End of code generation (_coder_dev_pipg_api.cpp)
