...
//
// _coder_dev_newtonzpipg_separatedinput_api.cpp
//
// Code generation for function '_coder_dev_newtonzpipg_separatedinput_api'
//
...
static const mxArray *emlrt_marshallOut(const struct0_T *u)
{
  ...
  static const char_T *b_sv[6]{"converge",   "xi",    "eta",
                               "solve_time", "ntime", "k"};
  const mxArray *b_y;
  const mxArray *c_y;
  const mxArray *d_y;
...
void e_dev_newtonzpipg_separatedinpu(c_dev_newtonzpipg_separatedinpu *SD,
                                     const mxArray *const prhs[17],
                                     const mxArray **plhs)
{
  coder::sparse P;
  coder::sparse g;
  ...
  dev_newtonzpipg_separatedinput(SD, &st, *A, *B, *At, *Bt, &P, *z1, *lw, &q,
                                 &g, *z_min, *z_max, lam, rho, omg, maxit,
                                 newtonratio, newtonactive, &out);
  // Marshall function outputs
  *plhs = emlrt_marshallOut(&out);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

// End of code generation (_coder_dev_newtonzpipg_separatedinput_api.cpp)
