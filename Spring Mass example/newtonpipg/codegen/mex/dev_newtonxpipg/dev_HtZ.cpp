...
static void binary_expand_op(real_T in1[736], int32_T in2, int32_T in4,
                             int32_T in5, const real_T in6[256],
                             const real_T in7[480], int32_T in8, int32_T in10,
...
void dev_HtZ(const emlrtStack *sp, const real_T At[256], const real_T Bt[128],
             const real_T z[480], real_T out[736])
{
  emlrtStack b_st;
  emlrtStack st;
  real_T b_out[16];
  ...
  std::memset(&out[0], 0, 736U * sizeof(real_T));
