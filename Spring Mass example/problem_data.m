...
%}
    ...
    pp.z0 = max(-pp.x_max, min(pp.x_max, ...
                [0.1*ones(pp.n/2,1);zeros(pp.n/2,1)] + 0.3*randn(pp.n,1) ...
                ));
    ...
    pp.expipg_omg = 100;            % Step-size ratio
    ...
    %Newton pipg will share the same coeffcient

    pp.newtonpipglinesearch_step = 2;%does not support. 
    pp.newtonpipglinsearch_amount =5;
    pp.newtonpipgnewtonratio = 0.9;
    pp.newtonpipgnewtonactive = 20;
    ...
    pp.quadprog_feas_tol = 1e-9;
    pp.quadprog_opt_tol = 1e-9;
    pp.quadprog_step_tol = 1e-9;
    ...
    osqptol = 1e-9;
    pp.osqp_abs_tol = osqptol;
    pp.osqp_rel_tol = osqptol;
    pp.osqp_prim_infeas = osqptol;
    
    scstol= 1e-9;
    pp.scs_abs_tol = scstol;
    pp.scs_rel_tol = scstol;  
    pp.scs_infeas_tol = scstol;
